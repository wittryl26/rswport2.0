...
const docsDir = path.join(staticDir, 'docs');

// Create directories if they don't exist
const dirs = [staticDir, imagesDir, docsDir];
dirs.forEach(dir => {
...
const placeholderImage = path.join(imagesDir, 'placeholder.jpg');
if (!fs.existsSync(placeholderImage)) {
  ...
  fs.writeFileSync(placeholderImage, buffer);
  console.log(`Created placeholder image at ${placeholderImage}`);
}

// Create a placeholder PDF
const placeholderPdf = path.join(docsDir, 'architecture.pdf');
...
%%EOF`;
  ...
  fs.writeFileSync(placeholderPdf, pdfContent);
  console.log(`Created placeholder PDF at ${placeholderPdf}`);
}
